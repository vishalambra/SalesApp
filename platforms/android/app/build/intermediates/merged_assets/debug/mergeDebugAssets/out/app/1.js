...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, teamService, router) {
        this.fb = fb;
        this.teamService = teamService;
        this.router = router;
        // reactive Login form 
        this.loginForm = this.fb.group({
            email: ['saral@jungleworks.com', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]],
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _team_service__WEBPACK_IMPORTED_MODULE_2__["TeamService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], LoginComponent);
